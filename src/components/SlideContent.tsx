...
import { SlideData, LearningObjective, ActivityAttempt, ActivityEvidence, ActivityRuntimeState } from '../types';
...
interface SlideContentProps {
  ...
  onActivityEvidence?: (evidence: ActivityEvidence, attempt?: ActivityAttempt) => void;
            ...
            {first10.map((item, idx) => {
              ...
              return (
                <div
                  ...
                  className="p-3.5 rounded-xl border border-[#D6DEE6] bg-white hover:border-[#116EEE]/40 transition-all cursor-pointer flex items-center justify-between shadow-2xs group"
                >
