...
export const LESSON_18: Lesson = {
  ...
  slides: [
    ...
    },
    {
      ...
      body: `<p>В коротком диалоге слушай не отдельное «модальное слово», а связку целиком: <b>что человек должен сделать, что умеет/может, что разрешено и чего он хочет</b>.</p>`,
    },
    {
      id: 9,
