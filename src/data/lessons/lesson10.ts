...
const L10_ROLEPLAY: LessonActivity = {
  ...
  turns: [
    ...
    { id: 'l10-rp-s3', speaker: 'waiter', prompt: 'Aha, értem. Honnan jössz majd? A könyvtárból?', next: 'l10-rp-l3' },
    ...
    { id: 'l10-rp-s4', speaker: 'waiter', prompt: 'Jó, akkor találkozzunk a kávézóban háromkor!', next: 'l10-rp-l4' },
    ...
    { id: 'l10-rp-s5', speaker: 'waiter', prompt: 'Várj, változás van: a kávézó zárva van. Menjünk inkább az étterembe.', next: 'l10-rp-l5' },
    ...
    { id: 'l10-rp-s6', speaker: 'waiter', prompt: 'Rendben. Mikor érsz oda?', next: 'l10-rp-l6' },
    ...
    { id: 'l10-rp-l8', speaker: 'learner', responseMode: 'selfPractice', prompt: 'Заверши разговор.', model: 'Jó, hamarosan találkozunk!', next: 'l10-rp-s9' },
