...
export const LESSON_6: Lesson = {
  ...
  slides: [
    ...
    },
    {
      ...
      subtitle: 'Итог урока 6 без завышенной оценки навыков',
      type: 'info',
      note: 'L6_EXIT_CHECK содержит 5 целей и связывает их с 6 активностями. Чтение, спряжение и множественное число могут получить прямое подтверждение по автоматически проверяемым заданиям. Числа и расписание, а также письменный профиль содержат открытую практику и поэтому требуют отдельной проверки.',
      warn: 'Произношение, role-play, устная практика и открытое письмо нельзя считать автоматически освоенными. Успешная загрузка или воспроизведение MP3 также не является языковым результатом.',
      task: 'Посмотрите статус пяти целей, повторите непройденные автоматически проверяемые задания и отдельно проверьте открытые задания перед переходом к уроку 7.',
      activities: [L6_EXIT_CHECK],
      body: `
        <h4 class="font-bold text-[#57121C] text-lg mb-2">1. Что реально связывает L6_EXIT_CHECK</h4>

        <p>
          В итоговой проверке есть <b>5 целей</b>, связанных с <b>6 активностями</b>.
          Цель по числам и расписанию использует сразу две активности:
          аудирование и role-play.
        </p>

        <table class="conj">
          <tr><th>Цель</th><th>Источник результата</th><th>Статус</th></tr>
          <tr>
            <td>чтение знакомых форм</td>
            <td><code>l6-cp-decoding</code></td>
            <td><b>DIRECT возможен</b></td>
          </tr>
          <tr>
            <td>настоящее время</td>
            <td><code>l6-cp-present-verbs</code></td>
            <td><b>DIRECT возможен</b></td>
          </tr>
          <tr>
            <td>числа, дни и расписание</td>
            <td><code>l6-listening-a0-review</code> + <code>l6-roleplay-schedule</code></td>
            <td><b>PARTIAL / REVIEW</b></td>
          </tr>
          <tr>
            <td>артикли и множественное число</td>
            <td><code>l6-cp-plural-articles</code></td>
            <td><b>DIRECT возможен</b></td>
          </tr>
          <tr>
            <td>письменный профиль</td>
            <td><code>l6-writing-profile</code></td>
            <td><b>PARTIAL / REVIEW</b></td>
          </tr>
        </table>

        <div class="note">
          <b>DIRECT</b> означает успешное выполнение конкретного автоматически проверяемого задания.
          Это не означает полное владение навыком во всех ситуациях.
        </div>

        <h4 class="font-bold text-[#57121C] text-lg mt-5 mb-2">2. Чтение не равно автоматической проверке произношения</h4>

        <p>
          Задания 6.2 проверяют распознавание букв и правил чтения:
          <b>s / sz, cs, gy, ty, ny, zs, j / ly</b> и долгие гласные.
        </p>

        <p>
          <button class="speak-btn" data-speak-text="szép, sok, gyár, kutya, nyár, hely" data-speak-lang="hu-HU">
            szép · sok · gyár · kutya · nyár · hely
          </button>
        </p>

        <div class="warn">
          Собственное произношение ученика не записывается и не оценивается автоматически.
          Поэтому успешное задание по чтению нельзя называть автоматическим подтверждением произношения.
        </div>

        <h4 class="font-bold text-[#57121C] text-lg mt-5 mb-2">3. Настоящее время</h4>

        <p>
          Здесь результат может быть прямым, потому что ответы имеют конкретные проверяемые формы:
        </p>

        <p>
          <button class="speak-btn" data-speak-text="tanulok, beszélünk, olvasnak, nem tanulok, dolgoznak, olvasol" data-speak-lang="hu-HU">
            tanulok · beszélünk · olvasnak · nem tanulok · dolgoznak · olvasol
          </button>
        </p>

        <div class="note">
          Прямой результат относится к этим заданиям. Он не означает автоматическое подтверждение
          свободного использования настоящего времени в новом разговоре.
        </div>

        <h4 class="font-bold text-[#57121C] text-lg mt-5 mb-2">4. Числа и расписание остаются PARTIAL / REVIEW</h4>

        <p>
          Аудирование 6.6 содержит пять проверяемых вопросов.
          Но эта же цель включает role-play о расписании, который является открытой практикой.
        </p>

        <p>
          <button class="speak-btn" data-speak-text="Kedden öt órakor tanulok. Csütörtökön nyolckor dolgozom." data-speak-lang="hu-HU">
            Kedden öt órakor tanulok. Csütörtökön nyolckor dolgozom.
          </button>
        </p>

        <div class="warn">
          Даже успешное аудирование не превращает всю цель в полностью автоматически подтверждённую:
          использование дня и времени в собственном диалоге нужно проверить отдельно.
        </div>

        <h4 class="font-bold text-[#57121C] text-lg mt-5 mb-2">5. Артикли и множественное число</h4>

        <p>
          Controlled practice 6.4 может проверяться напрямую:
        </p>

        <p>
          <button class="speak-btn" data-speak-text="az ablak, egy asztal, könyvek, almák, két könyv" data-speak-lang="hu-HU">
            az ablak · egy asztal · könyvek · almák · két könyv
          </button>
        </p>

        <div class="note">
          Здесь проверяются конкретные формы и выбор артикля,
          а не знание всех возможных существительных венгерского языка.
        </div>

        <h4 class="font-bold text-[#57121C] text-lg mt-5 mb-2">6. Письменный профиль остаётся PARTIAL</h4>

        <p>Профиль 6.7 должен содержать:</p>

        <ul class="tick">
          <li>имя;</li>
          <li>национальность или происхождение;</li>
          <li>одно действие в настоящем времени;</li>
          <li>один день и время.</li>
        </ul>

        <div class="warn">
          Письменный профиль нельзя считать автоматически пройденным.
          Его нужно проверить по рубрике 6.7.
          Устная версия профиля также не создаёт автоматический результат.
        </div>

        <h4 class="font-bold text-[#57121C] text-lg mt-5 mb-2">7. Что делать по итоговому статусу</h4>

        <table class="conj">
          <tr><th>Если проблема в...</th><th>Повторить</th></tr>
          <tr><td>чтении</td><td>6.2</td></tr>
          <tr><td>настоящем времени</td><td>6.5</td></tr>
          <tr><td>числах / аудировании / расписании</td><td>6.6</td></tr>
          <tr><td>артиклях и множественном числе</td><td>6.4</td></tr>
          <tr><td>письменном профиле</td><td>6.7</td></tr>
        </table>

        <div class="note">
          Слайды 6.3, 6.8 и 6.9 важны для обучения,
          но не являются отдельными строками evidence-графа L6_EXIT_CHECK.
        </div>

        <h4 class="font-bold text-[#57121C] text-lg mt-5 mb-2">8. Переход к уроку 7</h4>

        <p>
          На этом слайде нет отдельного искусственного числового порога перехода:
          решение опирается только на реальные статусы и активности L6_EXIT_CHECK.
        </p>

        <ol class="tasklist">
          <li>пройдите непройденные DIRECT-активности;</li>
          <li>выполните аудирование и отдельно role-play по расписанию;</li>
          <li>проверьте профиль 6.7 по рубрике;</li>
          <li>повторите области со статусом PARTIAL / REVIEW.</li>
        </ol>
        ...
        <div class="note">
          Завершение обзора A0 означает готовность продолжать обучение,
          а не отсутствие ошибок и не обязательный DIRECT-статус по всем пяти целям.
        </div>
      `,
    }
  ],
