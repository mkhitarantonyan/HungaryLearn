...
export const LESSON_21: Lesson = {
 ...
 `
  ...
  quiz: [
    {
      id: 2101,
      question: "С какими лицами в качестве прямого дополнения используется определенное спряжение?",
      options: ["Только с объектами 3-го лица", "Со всеми лицами", "Только с 1-м лицом", "Только со 2-м лицом"],
      correctIndex: 0,
      explanation: "Определенное спряжение используется только при объектах 3-го лица (őt, azt, a könyvet, Pétert, hogy...)."
    },
    {
      id: 2102,
      question: "Какое спряжение используется во фразе «Lát engem» (Он видит меня)?",
      options: ["Неопределенное", "Определенное", "Форма -lak/-lek", "Возвратное"],
      correctIndex: 0,
      explanation: "Дополнения 1-го лица (engem) требуют неопределенного спряжения."
    },
    {
      id: 2103,
      question: "Что выражает окончание -lak/-lek?",
      options: ["Подлежащее = я (1 л.), Объект = тебя / вас (2 л.)", "Подлежащее = ты, Объект = меня", "Прошедшее время", "Повелительное наклонение"],
      correctIndex: 0,
      explanation: "Суффикс -lak/-lek выражает действие 1-го лица единственного числа, направленное на 2-е лицо (я тебя/вас)."
    }
  ]
};
