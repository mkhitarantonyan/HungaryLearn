...
export const P1_L2_ROLEPLAY: RolePlayData = {
  ...
  turns: [
    ...
    { id: 'l2-p1-rp4', speaker: 'learner', responseMode: 'selfPractice', prompt: 'Назови своё имя.', model: 'Anna vagyok. Örülök!', next: 'l2-p1-rp4b' },
    ...
    { id: 'l2-p1-rp5', speaker: 'waiter', prompt: 'Én is jól vagyok. Magyar vagy?', next: 'l2-p1-rp6' },
    ...
    { id: 'l2-p1-rp7', speaker: 'waiter', prompt: 'És itt tanulsz?', next: 'l2-p1-rp8' },
    ...
    { id: 'l2-p1-rp9', speaker: 'waiter', prompt: 'Igen, én is itt tanulok. Örülök!', next: 'l2-p1-rp10' },
...
export const P1_L3_ROLEPLAY: RolePlayData = {
  ...
  completionMessage: 'Предметы названы. Ответы остаются PARTIAL до проверки человеком.', startTurnId: 'l3-p1-rp1', turns: [
    { id: 'l3-p1-rp1', speaker: 'waiter', prompt: 'Mi ez itt?', next: 'l3-p1-rp2' },
    ...
    { id: 'l3-p1-rp3', speaker: 'waiter', prompt: 'És mi az ott?', next: 'l3-p1-rp4' },
    ...
    { id: 'l3-p1-rp5', speaker: 'waiter', prompt: 'És mik ezek?', next: 'l3-p1-rp6' },
    ...
    { id: 'l3-p1-rp9', speaker: 'waiter', prompt: 'És hol van a telefon?', next: 'l3-p1-rp10' },
...
export const P1_L4_ROLEPLAY: RolePlayData = {
  ...
  completionMessage: 'Диалог о дне завершён. Он остаётся PARTIAL.', startTurnId: 'l4-p1-rp1', turns: [
    { id: 'l4-p1-rp1', speaker: 'waiter', prompt: 'És te mit csinálsz reggel?', next: 'l4-p1-rp2' },
    ...
    { id: 'l4-p1-rp5', speaker: 'waiter', prompt: 'Rendben. És mit csinálsz délután?', next: 'l4-p1-rp6' },
    ...
    { id: 'l4-p1-rp7', speaker: 'waiter', prompt: 'És este mit csinálsz?', next: 'l4-p1-rp8' },
    ...
    { id: 'l4-p1-rp11', speaker: 'waiter', prompt: 'Én délután dolgozom. És te?', next: 'l4-p1-rp12' },
    { id: 'l4-p1-rp12', speaker: 'learner', responseMode: 'selfPractice', prompt: 'Коротко ответь и попрощайся.', model: 'Én délután tanulok. Szia!', next: 'l4-p1-rp-end' },
...
export const P1_L5_ROLEPLAY: RolePlayData = {
  ...
  completionMessage: 'День и время подтверждены. Взаимодействие остаётся PARTIAL.', startTurnId: 'l5-p1-rp1', turns: [
    ...
    { id: 'l5-p1-rp2', speaker: 'learner', responseMode: 'selfPractice', prompt: 'Скажи, что в понедельник ты занят(а).', model: 'Sajnos hétfőn nem jó, dolgozom.', next: 'l5-p1-rp3' },
    ...
    { id: 'l5-p1-rp5', speaker: 'waiter', prompt: 'Háromkor jó?', next: 'l5-p1-rp6' },
    { id: 'l5-p1-rp6', speaker: 'learner', responseMode: 'selfPractice', prompt: 'Скажи, что три часа не подходит.', model: 'Sajnos háromkor nem jó.', next: 'l5-p1-rp7' },
    ...
    { id: 'l5-p1-rp9', speaker: 'waiter', prompt: 'Rendben, akkor kedden ötkor találkozunk.', next: 'l5-p1-rp10' },
    { id: 'l5-p1-rp10', speaker: 'learner', responseMode: 'selfPractice', prompt: 'Подтверди день и время.', model: 'Igen, kedden ötkor találkozunk.', next: 'l5-p1-rp11' },
    { id: 'l5-p1-rp11', speaker: 'waiter', prompt: 'És holnap ráérsz?', next: 'l5-p1-rp12' },
    { id: 'l5-p1-rp12', speaker: 'learner', responseMode: 'selfPractice', prompt: 'Ответь о завтрашнем дне.', model: 'Sajnos holnap nem jó, dolgozom.', next: 'l5-p1-rp13' },
...
export const P1_L6_ROLEPLAY: RolePlayData = {
  ...
  completionMessage: 'Первый день разыгран. Interaction остаётся PARTIAL.', startTurnId: 'l6-p1-rp1', turns: [
    { id: 'l6-p1-rp1', speaker: 'waiter', prompt: 'Jó napot! Te vagy az új diák?', next: 'l6-p1-rp2' },
    ...
    { id: 'l6-p1-rp3', speaker: 'waiter', prompt: 'Értem. Magyar vagy?', next: 'l6-p1-rp4' },
    ...
    { id: 'l6-p1-rp5', speaker: 'waiter', prompt: 'Rendben. Ez a tanterem. Mi ez itt?', next: 'l6-p1-rp6' },
    { id: 'l6-p1-rp6', speaker: 'learner', responseMode: 'selfPractice', prompt: 'Назови один предмет.', model: 'Ez egy könyv.', next: 'l6-p1-rp7' },
    { id: 'l6-p1-rp7', speaker: 'waiter', prompt: 'És mit csinálsz?', next: 'l6-p1-rp8' },
    ...
    { id: 'l6-p1-rp9', speaker: 'waiter', prompt: 'A tanfolyam hétfőn kilenckor van. Ez jó?', next: 'l6-p1-rp10' },
    ...
    { id: 'l6-p1-rp13', speaker: 'waiter', prompt: 'Rendben. Van kérdésed?', next: 'l6-p1-rp14' },
    ...
    { id: 'l6-p1-rp15', speaker: 'waiter', prompt: 'Kilenckor kezdődik. Viszlát!', next: 'l6-p1-rp16' },
