...
const COMPARISON_ROLEPLAY: LessonActivity = {
  ...
  turns: [
    ...
    { id: 'l9-rp-s3', speaker: 'waiter', prompt: 'Az A lakás közelebb van a metróhoz, ott jobb a közlekedés.', next: 'l9-rp-l3' },
    { id: 'l9-rp-l3', speaker: 'learner', responseMode: 'selfPractice', prompt: 'Сравни размер.', model: 'Igen, az A lakás nagyobb, mint a B lakás.', next: 'l9-rp-s4' },
    { id: 'l9-rp-s4', speaker: 'waiter', prompt: 'Igen, viszont az A lakás utcája jóval zajosabb.', next: 'l9-rp-l4' },
    { id: 'l9-rp-l4', speaker: 'learner', responseMode: 'selfPractice', prompt: 'Назови один недостаток.', model: 'Értem. A zajos utca nekem nagy hátrány.', next: 'l9-rp-s5' },
    ...
    { id: 'l9-rp-l7', speaker: 'learner', responseMode: 'selfPractice', prompt: 'Подтверди окончательный выбор.', model: 'A B lakást választom. Szerintem ez a jobb választás nekem.', next: 'l9-rp-s8' },
