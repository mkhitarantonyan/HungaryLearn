...
const L26_ACTIVITIES = createMigrationActivities({
  ...
  rolePlay: {
    ...
    turns: [
      { id: 'l26-rp-1', speaker: 'waiter', prompt: 'Mi a panasza?', next: 'l26-rp-2' },
      ...
      { id: 'l26-rp-3', speaker: 'waiter', prompt: 'Mióta érzi ezt?', next: 'l26-rp-4' },
      ...
      { id: 'l26-rp-5', speaker: 'waiter', prompt: 'Van láza?', next: 'l26-rp-6' },
      ...
      { id: 'l26-rp-7', speaker: 'waiter', prompt: 'Köhög?', next: 'l26-rp-8' },
      ...
      { id: 'l26-rp-9', speaker: 'waiter', prompt: 'Mennyire erős a fájdalom?', next: 'l26-rp-10' },
      ...
      { id: 'l26-rp-11', speaker: 'waiter', prompt: 'Szed valamilyen gyógyszert?', next: 'l26-rp-12' },
      ...
      { id: 'l26-rp-14', speaker: 'learner', prompt: 'Используй repair-реплику и попроси повторить или уточнить.', responseMode: 'selfPractice', model: 'Kérem, mondja még egyszer. Nem értettem pontosan.', next: 'l26-rp-15' },
      ...
      { id: 'l26-rp-16', speaker: 'learner', prompt: 'Подтверди, что понял(а), не добавляя диагноза.', responseMode: 'selfPractice', model: 'Értem: pihenek, folyadékot iszom, és ha nem vagyok biztos valamiben, szakembert kérdezek.' },
    ],
  },
  rolePlayB: {
    ...
    turns: [
      ...
      { id: 'l26-rpb-2', speaker: 'learner', prompt: 'Попроси простое безрецептурное средство от вымышленного симптома и назови длительность.', responseMode: 'selfPractice', model: 'Három napja fáj a torkom. Szeretnék valamit kérni torokfájás ellen.', next: 'l26-rpb-3' },
      { id: 'l26-rpb-3', speaker: 'waiter', prompt: 'Szed valamilyen más gyógyszert?', next: 'l26-rpb-4' },
      ...
      { id: 'l26-rpb-5', speaker: 'waiter', prompt: 'Ezt a vény nélkül kapható készítményt csak a csomagoláson lévő használati útmutató szerint használja. Ha bizonytalan, kérdezzen orvost vagy gyógyszerészt.', next: 'l26-rpb-6' },
      { id: 'l26-rpb-6', speaker: 'learner', prompt: 'Спроси о частоте и связи с едой.', responseMode: 'selfPractice', model: 'Hányszor kell használnom? Étkezés előtt vagy után?', next: 'l26-rpb-7' },
      ...
      { id: 'l26-rpb-8', speaker: 'learner', prompt: 'Подтверди понимание и вежливо заверши.', responseMode: 'selfPractice', model: 'Értem, elolvasom és követem az útmutatót. Köszönöm a segítséget.' },
    ],
  },
