...
const L16_LISTENING: LessonActivity = {
  kind: 'listening', id: 'l16-listening-shopping', title: 'Аудирование: покупка', assetId: 'l16_listening_shopping', audioStatus: 'missing', passCount: 3,
  transcript: 'Vásárló: Jó napot! Ezt kérem. Mennyibe kerül?\nEladó: Ezerötszáz forint.\nVásárló: Kérek két darabot. Fizethetek kártyával?\nEladó: Igen, természetesen.',
  questions: [
    { id: 'l16-list-1', question: 'Mit vesz a vásárló?', options: ['Ezt a terméket', 'Vonatjegyet', 'Kávét'], correctIndex: 0 },
...
const L16_ROLEPLAY: LessonActivity = {
  ...
  turns: [
    ...
    { id: 'l16-rp-l1', speaker: 'learner', responseMode: 'recorded', prompt: 'Поприветствуй продавца и спроси цену.', model: 'Jó napot! Ezt kérem. Mennyibe kerül?', next: 'l16-rp-s2' },
    { id: 'l16-rp-s2', speaker: 'waiter', prompt: 'Ezerötszáz forint.', next: 'l16-rp-l2' },
    { id: 'l16-rp-l2', speaker: 'learner', responseMode: 'choice', prompt: 'Выбери две штуки.', options: ['Kérek egyet.', 'Kérek két darabot.', 'Kérek öt forintot.'], branches: [
      { choice: 'Kérek egyet.', correct: false, feedback: 'Нужно két darabot.', nextTurnId: 'l16-rp-l2' },
      { choice: 'Kérek két darabot.', correct: true, nextTurnId: 'l16-rp-s3' },
      { choice: 'Kérek öt forintot.', correct: false, feedback: 'Это не нужное количество товара.', nextTurnId: 'l16-rp-l2' },
    ] },
...
const L16_EXIT: LessonActivity = { kind: 'exitCheck', id: 'l16-exit-check', title: 'Exit check — достижение целей урока', checks: [
...
export const LESSON_16: Lesson = {
  ...
  slides: [
    ...
    { id: 7, eyebrow: 'УРОК 16 · 7/12 · ЦЕНЫ', title: 'Практические цены', subtitle: 'Ограниченный набор', activities: [L16_CP_PRICES], body: `<p>Работаем только с ценами <b>500, 1000, 1500, 2000 и 2500 Ft</b>. Это не полная система больших чисел.</p><p>Mennyibe kerül? Ez 1500 forint. 1500 forintba kerül.</p><div class="note">После числительного forint остаётся в единственном числе. Цифровые ценники важнее свободного написания любых четырёхзначных чисел словами.</div>` },
    { id: 8, eyebrow: 'УРОК 16 · 8/12 · ФРАЗЫ', title: 'Количество и оплата', subtitle: 'Готовые транзакционные блоки', activities: [L16_LISTENING], body: `<p>Kérek egyet. — Один, пожалуйста. Kérek két darabot. — Две штуки, пожалуйста.</p><p>Mennyibe kerül ez? Ez túl drága.</p><p>Kártyával fizetek. — Я плачу картой. Készpénzzel fizetek. — Я плачу наличными.</p><div class="note">Fizethetek kártyával? — готовый транзакционный блок. Продуктивное образование -hat/-het здесь не изучается и не проверяется.</div>` },
    { id: 9, eyebrow: 'УРОК 16 · 9/12 · ДИАЛОГ', title: 'Покупка', subtitle: 'Цена → количество → оплата', activities: [L16_ROLEPLAY], body: `<p><b>Eladó:</b> Jó napot! Segíthetek?</p><p><b>Vásárló:</b> Jó napot! Ezt kérem. Mennyibe kerül?</p><p><b>Eladó:</b> 1500 forint.</p><p><b>Vásárló:</b> Kérek két darabot.</p><p><b>Eladó:</b> Rendben. Hogyan fizet?</p><p><b>Vásárló:</b> Kártyával fizetek.</p><div class="note">Цена, количество и оплата измеряются как функции; условное наклонение и продуктивное -hat/-het не являются целями.</div>` },
