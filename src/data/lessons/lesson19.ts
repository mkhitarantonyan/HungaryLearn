...
export const LESSON_19: Lesson = {
  ...
  slides: [
    ...
    },
    {
      ...
      body: `<p>В записи прозвучит короткий рассказ: одно событие произошло вчера, одно происходит сегодня, остальные относятся к будущему.</p><div class="warn">Отдельная запись для этого задания ещё не опубликована, поэтому аудирование пока недоступно.</div>`,
    },
    {
      id: 10,
