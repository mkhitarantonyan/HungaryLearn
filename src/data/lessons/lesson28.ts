...
export const LESSON_28: Lesson = {
 ...
 `
    },
    {
      ...
      body: `
   <ul class="tick">
     <li><b>Агглютинация:</b> Все значения передаются суффиксами, нанизываемыми на корень слова (ház -> házam -> házamban -> házamból).</li>
 ...
 `
    },
    {
      ...
      title: "Gratulálunk!",
      subtitle: "Вы успешно завершили весь курс B1!",
      body: `
   <div style="text-align:center; padding: 20px 0;">
     <h3 style="color:#d97706; font-size:1.5rem; margin-bottom:12px;">Sikeresen teljesítetted a B1 szintet!</h3>
     <p style="font-size:1.1rem; color:#4b5563;">Поздравляем! Вы освоили фундамент венгерского языка от уровня A1 до B1.</p>
     <p style="font-size:1rem; color:#6b7280; margin-top:8px;">Теперь вы можете уверенно вести беседу, выражать мысли, общаться в повседневных ситуациях и продолжать совершенствовать свой разговорный уровень!</p>
   </div>
  ...
  quiz: [
    {
      ...
      correctIndex: 0,
      explanation: "Венгерский — агглютинативный язык: грамматические значения выражаются присоединением суффиксов к неизменяемому корню."
    },
    {
      id: 2802,
