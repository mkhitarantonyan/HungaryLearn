...
export const LESSONS_META: LessonMeta[] = [
  ...
  },
  {
    ...
    number: 3,
    level: 'A0',
    title: 'Урок 3 · Глагол «быть» (Lenni) и множественное число',
    subtitle: 'Спряжение lenni, опускание в 3-м лице, показатель множественного числа -k',
    description: 'Глагол lenni (быть/находиться) в настоящем времени, золотое правило опускания van/vannak, образование множественного числа существительных (-k) и числительные 1-10.',
    slidesCount: 11
  },
  {
    id: 4,
    number: 4,
    level: 'A0',
    title: 'Урок 4 · Настоящее время (Jelen idő) — Неопределённое спряжение',
    subtitle: 'Alanyi ragozás, регулярные окончания глаголов, отрицание nem',
    description: 'Образование неопределённого (субъектного) спряжения глаголов в настоящем времени, типы гласных основ, отрицательная частица nem, повседневные глаголы и диалоги.',
    slidesCount: 12
  },
  {
    id: 5,
    number: 5,
    level: 'A0',
    title: 'Урок 5 · Винительный падеж (-t) и ik-глаголы',
    subtitle: 'Tárgyeset (-t), ik-глаголы, числительные 11-100',
    description: 'Винительный падеж прямого дополнения (-t), особенности присоединения к согласным, порядок слов при прямом дополнении, ik-глаголы (eszik, iszik) и числительные от 11 до 100.',
    slidesCount: 12
  },
  {
    id: 6,
    number: 6,
    level: 'A0',
    title: 'Урок 6 · Определённое спряжение (Tárgyas ragozás)',
    subtitle: 'Определённое артиклевое спряжение глаголов и указательные местоимения',
    description: 'Уникальное для венгерского языка определённое (объектное) спряжение глаголов, когда и зачем оно используется (a/az, ez a/az a), правила гармонии гласных при спряжении и практика.',
    slidesCount: 10
  },
  {
    id: 7,
