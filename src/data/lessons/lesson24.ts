...
const L24_ACTIVITIES = createMigrationActivities({
  ...
  rolePlay: {
    ...
    turns: [
      { id: 'l24-rp-1', speaker: 'waiter', prompt: 'Szerintem jobb az irodában dolgozni, mert könnyebb együttműködni.', next: 'l24-rp-2' },
      { id: 'l24-rp-2', speaker: 'learner', prompt: 'Сформулируй свою позицию и первую причину.', responseMode: 'selfPractice', model: 'Szerintem az otthoni munka jobb, mert nem kell utazni.', next: 'l24-rp-3' },
      { id: 'l24-rp-3', speaker: 'waiter', prompt: 'Viszont otthon nehezebb gyorsan kérdezni a kollégáktól.', next: 'l24-rp-4' },
      ...
      { id: 'l24-rp-5', speaker: 'waiter', prompt: 'Mondanál egy példát?', next: 'l24-rp-6' },
      ...
      { id: 'l24-rp-7', speaker: 'waiter', prompt: 'Akkor szerinted mi lenne a legjobb megoldás?', next: 'l24-rp-8' },
      { id: 'l24-rp-8', speaker: 'learner', prompt: 'Сделай вывод.', responseMode: 'selfPractice', model: 'Összességében a hibrid rendszer lenne a legjobb megoldás.' },
    ],
  },
