...
const L20_ACTIVITIES = createMigrationActivities({
  ...
  rolePlay: {
    ...
    turns: [
      { id: 'l20-rp-1', speaker: 'waiter', prompt: 'Tegnap későn érkeztél. Hova mentél?', next: 'l20-rp-2' },
      ...
      { id: 'l20-rp-3', speaker: 'waiter', prompt: 'Mi történt először?', next: 'l20-rp-4' },
      { id: 'l20-rp-4', speaker: 'learner', prompt: 'Назови первое событие и маркер последовательности.', responseMode: 'selfPractice', model: 'Először későn keltem, ezért sietnem kellett.', next: 'l20-rp-5' },
      { id: 'l20-rp-5', speaker: 'waiter', prompt: 'Miért késtél el?', next: 'l20-rp-6' },
      { id: 'l20-rp-6', speaker: 'learner', prompt: 'Объясни причину опоздания.', responseMode: 'selfPractice', model: 'Lekéstem a buszt, és a következő járat is késett.', next: 'l20-rp-7' },
      { id: 'l20-rp-7', speaker: 'waiter', prompt: 'Mit csináltál ezután?', next: 'l20-rp-8' },
      { id: 'l20-rp-8', speaker: 'learner', prompt: 'Расскажи о своём действии или альтернативном маршруте.', responseMode: 'selfPractice', model: 'Azután metróval mentem tovább, majd gyalogoltam.', next: 'l20-rp-9' },
      { id: 'l20-rp-9', speaker: 'waiter', prompt: 'Felhívtál vagy írtál valakinek?', next: 'l20-rp-10' },
      { id: 'l20-rp-10', speaker: 'learner', prompt: 'Скажи, кому и что ты сообщил(а).', responseMode: 'selfPractice', model: 'Igen, írtam a kollégámnak, hogy késni fogok.', next: 'l20-rp-11' },
      { id: 'l20-rp-11', speaker: 'waiter', prompt: 'Mi történt később?', next: 'l20-rp-12' },
      { id: 'l20-rp-12', speaker: 'learner', prompt: 'Продолжи связный рассказ.', responseMode: 'selfPractice', model: 'Később megérkeztem, és rögtön elkezdtük a találkozót.', next: 'l20-rp-13' },
      { id: 'l20-rp-13', speaker: 'waiter', prompt: 'Végül megoldódott a probléma?', next: 'l20-rp-14' },
      { id: 'l20-rp-14', speaker: 'learner', prompt: 'Сообщи итог и мнение.', responseMode: 'selfPractice', model: 'Igen, végül mindent megbeszéltünk, de kellemetlen volt a késés.', next: 'l20-rp-15' },
      { id: 'l20-rp-15', speaker: 'waiter', prompt: 'Mit fogsz másképp csinálni legközelebb?', next: 'l20-rp-16' },
      { id: 'l20-rp-16', speaker: 'learner', prompt: 'Назови практическое изменение на будущее.', responseMode: 'selfPractice', model: 'Legközelebb korábban indulok, és előre ellenőrzöm a menetrendet.' },
    ],
  },
