...
export const LESSON_23: Lesson = {
 ...
 `
  ...
  quiz: [
    {
      id: 2301,
      question: "Какой суффикс является маркером условного наклонения в 3-м лице единственного числа (ő)?",
      options: ["-na / -ne", "-j-", "-t-", "-va / -ve"],
      correctIndex: 0,
      explanation: "Маркером условного наклонения для 3-го лица единичного числа является суффикс -na / -ne (tanulna, kérne)."
    },
    {
      id: 2302,
      question: "Как переводится фраза «Jó lenne találkozni»?",
      options: ["Было бы хорошо встретиться", "Мы точно встретимся", "Встречайся со мной", "Не нужно встречаться"],
      correctIndex: 0,
      explanation: "Lenne — условная форма от lenni («было бы»). «Jó lenne találkozni» = «Было бы хорошо встретиться»."
    },
    {
      id: 2303,
      question: "Какое наклонение используется в предложении с союзom ha (если бы...)?",
      options: ["Условное наклонение в обеих частях", "Повелительное в первой, изъявительное во второй", "Будущее время", "Только настоящее"],
      correctIndex: 0,
      explanation: "В гипотетических предложениях со смыслом «если бы... то...» условное наклонение используется в обеих частях предложения."
    }
  ]
};
